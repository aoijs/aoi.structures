export declare class SuperSet<T = unknown> extends Set<T> {
    ...
    find(data: (this: void, value: T, index: number, obj: T[]) => value is T): T;
    union(...sets: (SuperSet<T> | Set<T>)[]): SuperSet<T> | Set<T>;
    intersection(...sets: (SuperSet<T> | Set<T>)[]): SuperSet<T> | Set<T>;
